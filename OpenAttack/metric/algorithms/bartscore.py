...
class BARTScore(AttackMetric):
    ...
    def __init__(self, checkpoint='facebook/bart-large-cnn'):
        ...
        We use CNNDM version BARTScore.
        :Language: english
        
        """
        self.bart_scorer = BARTScorer(device='cuda', checkpoint=checkpoint) 
    ...
    def calc_score(self, sentA, sentB):
        ...
        score = self.bart_scorer.score(srcs=[sentA], tgts=[sentB])[0]
        return score
